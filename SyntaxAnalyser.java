...
public class SyntaxAnalyser extends AbstractSyntaxAnalyser{
    ...
    public String ErrorString(String expected, Token next){
        return "line " + next.lineNumber + " in " + this.fileName + ": - Expected token(s): " + expected + " but found: (' " + next.text + " ').";
    }
    ...
    public String non_terminal_error(String nonTerminal, Token token){
        return "line " + token.lineNumber + " in " + this.fileName + ": - Parsing error : " + nonTerminal;
    }
